...
const services = [
  {
    ...
    text: `A Flexi Desk / Hot Desk in ADGM, Abu Dhabi gives you an affordable and flexible way to work from a professional coworking space at Addax Tower, Al Reem Island. Starting from AED 1,000 per month, this flexible workspace provides shared seating, 24/7 member access, high-speed Wi-Fi and meeting room access. It is ideal for freelancers, remote workers, consultants and businesses looking for a Flexi Desk in ADGM, Hot Desk in Abu Dhabi, coworking space in ADGM, affordable workspace in Abu Dhabi or flexible office space near ADGM.`,
  ...
  },
  {
    ...
    text: `A Dedicated Desk in ADGM, Abu Dhabi gives you a fixed, permanent workstation at Aegis Coworking in Addax Tower, Al Reem Island. Starting from AED 1,150 per month, the dedicated workspace includes 24/7 access, a professional coworking environment, meeting room access and a registered ADGM business address. It is suitable for professionals, freelancers, consultants and businesses looking for a Dedicated Desk in ADGM, dedicated workspace in Abu Dhabi, office space in ADGM, coworking space in Al Reem Island or a professional business centre in ADGM.',
    href: `${MAIN_SITE}/office-space`,
