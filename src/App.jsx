...
const services = [
  {
    ...
    text: `An affordable Flexi / Hot Desk in ADGM, Abu Dhabi from AED 1,000 per month, ideal for freelancers, remote workers and professionals who want a coworking space without committing to a permanent desk. Work from Addax Tower, Al Reem Island, close to the ADGM business district.`,
  ...
  text: `A Dedicated Desk in ADGM, Abu Dhabi from AED 1,150 per month gives professionals and businesses a permanent place to work within a shared workspace. Located at Addax Tower, it is suited to those looking for a dedicated workspace with an ADGM business address.`,
  href: `${MAIN_SITE}/office-space`,
...
},
  {
    ...
    text: 'A Private Office in ADGM, Abu Dhabi starts from AED 4,500 per month and provides businesses with their own enclosed office space at Addax Tower. A practical option for companies and teams seeking privacy within a premium business center in ADGM.',
  ...
  },
  {
    ...
    text: 'A Virtual Office in ADGM, Abu Dhabi starts from AED 292 per month for businesses that need an established presence without leasing a physical workspace. Get an ADGM business address at Addax Tower, Al Reem Island, while keeping your office costs affordable.',
  ...
  },
  {
    ...
    text: 'A Meeting Room in ADGM, Abu Dhabi is available for businesses, consultants and professionals who need a convenient place for client meetings, interviews or discussions. Located at Addax Tower, it offers an accessible meeting space within a business center near ADGM.',
