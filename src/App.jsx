...
const services = [
...
},
  {
    ...
    text: 'A Private Office in ADGM, Abu Dhabi gives your business a fully furnished, lockable workspace with 24/7 access and a registered ADGM business address. At Aegis Coworking in Addax Tower, Al Reem Island, private office space starts from AED 4,500 per month and is suitable for teams of 1 to 20+ professionals. Your private office includes ergonomic desks and chairs, lockable storage, high-speed internet, meeting room access, mail handling and a professional business environment. It is ideal for companies, consultants, legal and finance professionals, international businesses and growing teams looking for a Private Office in ADGM, private office in Abu Dhabi, office space in ADGM, dedicated workspace, dedicated office space, workspace ADGM, coworking space ADGM, business centre in ADGM, business center in ADGM, affordable office space in Abu Dhabi, or a professional office near ADGM.',
  ...
  },
  {
    ...
    text: 'Book a professional Meeting Room in ADGM, Abu Dhabi at Aegis Coworking, located in Addax Tower, Al Reem Island. Our flexible meeting room rental is available by the hour with no long-term commitment, making it ideal for client meetings, business meetings, team discussions, interviews, presentations and video conferences. Each meeting room provides comfortable seating, high-speed Wi-Fi, presentation screens, professional video conferencing equipment, a whiteboard, power outlets and refreshments. Whether you need a meeting room in ADGM, meeting room in Abu Dhabi, meeting room in Abu Dhabi Global Market, conference room ADGM, conference room Abu Dhabi, business meeting room, meeting space ADGM, meeting space Abu Dhabi, or a professional workspace near ADGM, Aegis Coworking provides a convenient business centre in ADGM for professionals, companies, consultants and remote teams.',
  ...
  },
  {
    ...
    text: 'Get a flexible Coworking Day Pass in ADGM, Abu Dhabi at Aegis Coworking in Addax Tower, Al Reem Island, with no lease, membership or long-term commitment. Starting from AED 100 per day for 9 AM–6 PM access, or AED 150 for 24-hour access, the Day Pass includes Hot Desk access, high-speed Wi-Fi, premium coffee, printing and scanning, and access to coworking amenities. It is ideal for freelancers, remote workers, consultants, business travelers, entrepreneurs and professionals looking for a Day Pass in ADGM, coworking day pass in Abu Dhabi, Hot Desk in ADGM, Hot Desk in Abu Dhabi, coworking space ADGM, coworking space Abu Dhabi, flexible workspace ADGM, workspace in Abu Dhabi, affordable coworking space, business centre in ADGM or a professional workspace near ADGM.',
